    ...
    return (
        <Card placeholder={undefined}
            ...
            <CardHeader placeholder={undefined}
                        onPointerEnterCapture={undefined}
                        onPointerLeaveCapture={undefined} floated={false} className="mx-0 mt-0 mb-6 h-48">
                <Image
                    src={img}
                    alt={title}
                    width={768}
            ...
            <CardBody placeholder={undefined}
                ...
                >
                    <Typography placeholder={undefined}
                                onPointerEnterCapture={undefined}
                                onPointerLeaveCapture={undefined} variant="h5" className="mb-2">
                        {title}
                    </Typography>
                </a>
                <Typography placeholder={undefined}
                ...
                >
                    <Button placeholder={undefined}
                            onPointerEnterCapture={undefined}
                            onPointerLeaveCapture={undefined} color="gray" size="sm">
                        see details
                    </Button>
                </Typography>
            </CardBody>
